...
extern "C" {
  #[link_name = "\u{1}_Z11deleteVkFFTP16VkFFTApplication"]
  pub fn deleteVkFFT(app: *mut VkFFTApplication);
}
extern "C" {
  #[link_name = "\u{1}_Z9VkFFTSyncP16VkFFTApplication"]
  pub fn VkFFTSync(app: *mut VkFFTApplication) -> VkFFTResult;
}
extern "C" {
  #[link_name = "\u{1}_Z11VkFFTAppendP16VkFFTApplicationiP17VkFFTLaunchParams"]
  pub fn VkFFTAppend(
...
extern "C" {
  #[link_name = "\u{1}_Z15initializeVkFFTP16VkFFTApplication18VkFFTConfiguration"]
...
extern "C" {
  #[link_name = "\u{1}_Z13VkFFTPlanAxisP16VkFFTApplicationP9VkFFTPlanmmmm"]
...
extern "C" {
  #[link_name = "\u{1}_Z15VkFFTGetVersionv"]
